    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BandsId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseImageUrl = table.Column<string>(type: "text", nullable: true),
                    DetailsImageUrl = table.Column<string>(type: "text", nullable: true),
                    NumberOfItemsOnHold = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "15deed41-a5ef-4c17-80a3-38a84fbc47af", null, "User", "USER" },
                    { "72835638-C499-4941-9357-135FCBBA2E33", null, "Admin", "ADMIN" },
                    { "a62aa6cc-fa7b-4235-aad9-179dd36a98f9", null, "Guest", "Guest" }
                });
